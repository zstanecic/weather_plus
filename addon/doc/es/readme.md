...
Weather Plus Configuración submenú
...
f1: ayuda con la localización, f2: última selección con TAB, f3: lista y cuadro de edición, f4: control de la duración del Pronóstico del Tiempo, f5: controles de volumen.
...
Después de pulsar en el elemento "Establecer y Administrar Tus Ciudades...", puedes encontrar otros botones como sigue:
...
Este botón se activa si selecciona una ciudad en la lista, o ha pasado la prueba.
...
Este botón se activa Si los efectos de audio están instalados, y activados, y seleccionas una ciudad en la lista, o ha pasado la prueba.

# Predeterminar #

Predetermina la ciudad actual por defecto, se usará  cada vez que reinicies el complemento.

Este botón se activa si selecciona una ciudad previamente insertada en la lista y no predeterminada, o ha pasado la prueba.

# Quitar #

Eliminar la ciudad actual de tu lista.

Este botón se activa si selecciona una ciudad previamente insertada en la lista.
...
Este botón se activa si tienes añadido y guardado al menos una ciudad en la lista.
...
Esta casilla de verificación también te permite gestionar la instalación de los efectos de audio;

Si los efectos de audio están instalados y la casilla de verificación está activada, la tecla F5 y el parámetro del volumen está disponible.

También estará disponible una casilla de verificación adicional:

* Usa solo efectos del tiempo.

Puedes cambiar el volumen general o cambiar el último efecto de audio escuchado y filtrar los otros efectos  de audio en tu entorno.
...
Si está habilitado, permite escuchar solo los efectos del tiempo como lluvia, viento, truenos, etc., filtrando todos los efectos ambientales.

casilla de verificación no marcado (por defecto)

# Habilitar la lectura de las horas en formato 24-horas #

si deshabilitado  anuncia la hora en formato 12-horas, ejemplo: 12 AM `-` 12 PM.

casilla de verificación marcado (por defecto)

# Indica la espera con un pitido mientras se busca el boletín más reciente #

Si está habilitado, escuchas un pitido para indicar el estado de la búsqueda en curso hasta que se encuentre el último informe meteorológico más actualizado.
...
Si está habilitado, activa una casilla de verificación adicional que te permite indicar la presión en milímetros de mercurio.
...
Si está habilitado, utiliza la coma como un separador decimal, de lo contrario, utiliza el punto.

casilla de verificación no marcado (por defecto)

# Buscar Actualización... #

Si está habilitado, este da una alerta cuando hay una actualización del complemento.

casilla de verificación marcado (por defecto)

# Pulsa el botón Aceptar para confirmar la acción o el botón Cancelar para cancelar la acción. #
...
* Corregida pantalla de ayuda en los botones;
...
`#`Cambios en la ventana de Weather Plus:
...
# Versión 2.8 #
* Corregido bug en "detalles"
	* Abrió la ventana de las coinsidencias cuando no pudo encontrar la ciudad.
...
`#`Cambios en la ventana de configuración de Weather Plus:
...
# Versión 2.4.4 #
* Se añadio  dos cadenas a la lista de los informes meteorológicos
* Se añadio  localización Español y Francés (gracias a Pablo Vargas y Rémy Ruiz)

# Versión 2.4.3 #
* Añadiendo la previsión meteorológica para los próximos 4 días
...
* A continuación, también es posible probar / añadir / eliminar / predeterminar el Código Postal por defecto establecido en una lista.
...
# Versión 2.0 #
* El menú deconfiguración de Weather Plus    se ha movido al submenú Preferencias
* La entrada correcta ya no se guarda sobre la marcha, sino que es temporal.
